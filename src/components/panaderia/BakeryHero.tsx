    ...
    <section className="flex flex-col lg:flex-row min-h-[640px] w-full bg-slate-950">
      ...
      <div className="relative lg:w-3/5 min-h-[420px] lg:min-h-0 overflow-hidden group">
        ...
        >
          <div className="flex items-center gap-2 bg-black/50 backdrop-blur-md px-4 py-2.5 rounded-full border border-white/20">
            <span className="material-symbols-outlined text-accent text-[16px]">verified</span>
            <span className="text-white text-sm font-semibold">
              Tecnología Industrial para Panaderos
            </span>
          </div>
        </motion.div>
      </div>
      ...
      <div className="relative lg:w-2/5 bg-bg-dark text-white p-8 lg:p-14 xl:p-16 flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            <span className="material-symbols-outlined text-[18px] text-accent">bakery_dining</span>
            <span className="text-accent text-sm font-bold uppercase tracking-widest">Panadería Profesional</span>
          </motion.div>
          ...
          >
            <div>
              <p className="text-accent font-black text-3xl font-display tracking-tight">±1°C</p>
              <p className="text-white/45 text-xs mt-1 uppercase tracking-widest">Precisión Térmica</p>
            </div>
            <div>
